...
const { kConnector, kSize, kConnected, kRunning, kPending, kUrl, kBusy } = require('./core/symbols')
...
class Pool extends Dispatcher {
  constructor (origin, { connections, factory, connector, tls, socketPath, ...options } = {}) {
    super()
    ...
    this[kOptions] = { ...JSON.parse(JSON.stringify(options)), connector: this[kConnector] }
    ...
    this[kQueued] = 0
    this[kFactory] = factory || ((opts) => new Client(origin, opts))
